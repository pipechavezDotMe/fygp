...
class Proyecto(models.Model):
    ...
    aliados = models.ImageField(upload_to='aliados', blank=True, null=True, verbose_name="Aliados")
    contratantes = models.ImageField(upload_to='contratantes', blank=True, null=True, verbose_name="Contratantes")
